...
\question[2]{
Show that $T(n)=4T(\frac{n}{2})+n \in \Theta(n^2)$. You'll need to subtract off a lower-order term to make the induction work here. \emph{Note: we are using big-theta here, so you'll need to prove the upper AND lower bound.}
}
