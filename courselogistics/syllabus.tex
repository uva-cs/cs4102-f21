...
\textbf{\Large CS 4102: Algorithms} \hfill \textbf{\Large Fall 2021}

\vskip 0.5in 

\makebox[\textwidth][c]{
\begin{tabular}{p{2.6in}p{2.6in}}
    \textbf{Tu/Th 12:30 am--1:45 pm } & \textbf{Tu/Th 2:00--3:15 pm}\\
    \textbf{Instructor:} Mark Floryan & \textbf{Instructor:} Tom Horton\\
    Email: \url{mfloryan@cs.virginia.edu} & Email: \url{horton@virginia.edu}\\
    Office: Rice Hall 203 & Office: Rice Hall 402\\
   Office Hours: TBD. See course website & Office Hours: TBD. See course website\\
...
\vskip 0.1in
\textbf{Teaching Assistants:} See course website.  Office hours will be done in-person and using Discord. Join the course's ``server:''  {\tt https://discord.gg/GqqakWbs} 


\vskip 0.1in
\textbf{Course website:} {\tt https://uva-cs.github.io/cs4102-f21/}   (We will also use Collab.)

\textbf{Prerequisites:} CS 2102 and 2150 with grades of C- or higher, and math knowledge from APMA 1090 or MATH 1210 or MATH 1310. (Prerequisites are important to this course and will be enforced!)
...
The course is divided into 10 {\bf modules}:
\begin{itemize}
    \item  Divide \& Conquer: Insertion Sort, Mergesort, Quicksort
    \item Divide \& Conquer: Recurrence Relations
    \item Divide \& Conquer: Advanced Topics
    \item Graphs: Breadth-first Search (BFS) \& Depth Search (DFS)
    \item Graphs: Kruskal’s and Find-Union 
    \item Graphs: Prim’s \& Dijkstra’s
    \item Greedy Algorithms
    \item Dynamic Programming
    \item Network Flow and Ford-Fulkerson
    \item Bi-Partite Matching \& Reductions
\end{itemize}
Most modules are 2 lectures worth of content (but a few are 3 or 4). The schedule is shown on the website. 
For each module, there will be:
\begin{itemize}
    \item 1 homework (written or programming)
    \item 1 quiz
\end{itemize}

\textbf{Quizzes:}  Each quiz is a short assessment of your knowledge of a module. So quizzes are meant to ensure you clearly demonstrate competence regarding the individual topics for that module.  You will have multiple opportunities to take each quiz (3 attempts for the first eight, but only 2 chances to take the last two quizzes).
...
Final Exam period, Tue, Dec 14, 7:00 pm 	&	Mod 1-10 (final attempts) \\
\end{tabular}

\textbf{Homeworks:} Homeworks fall into two categories:  ``written'' and ``programming.'' Programming homeworks can use Python, Java or C++. Some assignments will require a write-up in addition to code.  Written homeworks may include small problems, runtime analysis, proofs, etc.   See section about \LaTeX{} below.
...
\begin{itemize}
    \item We will use a grading approach based on a an approach called {\it masterry learning\/}. Our approach tries to model the CS department's official policy on what course grades should mean, found at {\tt http://ugrads.cs.virginia.edu/grading-guidelines.html}
    ...
    \item To pass a module, you must pass the module's homework and get a pass or high-pass on its quiz.
