...
\begin{tabular}{p{2.6in}p{2.6in}}
    ...
    Office: Rice Hall 210 & Office: Rice Hall 401\\
   Office Hours: See course website. & Office Hours:\\
...
\vskip 0.1in
\textbf{Course website:} {\tt https://uva-cs.github.io/cs4102-f21/}   We will also use of Collab.
...
\begin{itemize}
    ...
    \item With some limitations, a quiz or homework that can be done again to earn a higher score.
